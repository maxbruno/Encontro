...
@section('title', 'Nova Pessoa - Encontro')
        ...
        <div class="row">
            <div class="col-md-10 offset-md-1">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1><i class="bi bi-person-plus-fill"></i> Nova Pessoa</h1>
                    <a href="{{ route('people.index') }}" class="btn btn-outline-secondary">
                        <i class="bi bi-arrow-left"></i> Voltar à Lista
                    </a>
                </div>

                <form method="POST" action="{{ route('people.store') }}" enctype="multipart/form-data" id="personForm">
                    @csrf
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                                           value="{{ old('name') }}" required maxlength="150" placeholder="Nome completo">
                                    @error('name')
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="type" id="type" class="form-select @error('type') is-invalid @enderror" required>
                                        ...
                                        <option value="Casal" {{ old('type') == 'Casal' ? 'selected' : '' }}>Casal</option>
                                        <option value="Jovem" {{ old('type') == 'Jovem' ? 'selected' : '' }}>Jovem</option>
                                        <option value="Adolescente" {{ old('type') == 'Adolescente' ? 'selected' : '' }}>Adolescente</option>
                            ...
                            <div class="row mb-3" id="spouseRow" style="display: none;">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="spouse" id="spouse" class="form-control @error('spouse') is-invalid @enderror" 
                                           value="{{ old('spouse') }}" maxlength="150" placeholder="Nome do cônjuge">
                                    @error('spouse')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <div class="border rounded p-3" id="dropZone" style="background-color: #f8f9fa; cursor: pointer;">
                                        ...
                                        <div class="text-center" id="dropZoneContent">
                                            ...
                                            <div id="dropZoneText">
                                                ...
                                                <p class="mb-0 mt-2">Clique para selecionar uma foto ou arraste aqui</p>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="cell_phone" id="cell_phone" class="form-control @error('cell_phone') is-invalid @enderror" 
                                           value="{{ old('cell_phone') }}" maxlength="20" placeholder="(00) 00000-0000">
                                    @error('cell_phone')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" 
                                           value="{{ old('phone') }}" maxlength="20" placeholder="(00) 0000-0000">
                                    @error('phone')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" 
                                           value="{{ old('email') }}" maxlength="150" placeholder="exemplo@email.com">
                                    @error('email')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror" 
                                           value="{{ old('address') }}" maxlength="200" placeholder="Rua, número, complemento">
                                    @error('address')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="district" id="district" class="form-control @error('district') is-invalid @enderror" 
                                           value="{{ old('district') }}" maxlength="100" placeholder="Bairro">
                                    @error('district')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="zip_code" id="zip_code" class="form-control @error('zip_code') is-invalid @enderror" 
                                           value="{{ old('zip_code') }}" maxlength="10" placeholder="00000-000">
                                    @error('zip_code')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="group" id="group" class="form-control @error('group') is-invalid @enderror" 
                                           value="{{ old('group') }}" maxlength="100" placeholder="Núcleo ou grupo">
                                    @error('group')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="father_name" id="father_name" class="form-control @error('father_name') is-invalid @enderror" 
                                           value="{{ old('father_name') }}" maxlength="150" placeholder="Nome do pai">
                                    @error('father_name')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="mother_name" id="mother_name" class="form-control @error('mother_name') is-invalid @enderror" 
                                           value="{{ old('mother_name') }}" maxlength="150" placeholder="Nome da mãe">
                                    @error('mother_name')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="notes" id="notes" class="form-control @error('notes') is-invalid @enderror" 
                                              rows="3" maxlength="500" placeholder="Observações gerais...">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <button type="submit" name="action" value="saveAndNew" class="btn btn-success btn-lg">
                                        <i class="bi bi-plus-circle"></i> Salvar e Novo
                                    </button>
                                </div>
                                <div>
